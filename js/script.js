...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('scroll', function() {
        ...
        // Mostrar/ocultar botão de agendamento fixo com base na rolagem
        const appointmentFixed = document.querySelector('.appointment-fixed');
        if (scrollPosition > 300) {
            appointmentFixed.style.opacity = '1';
            appointmentFixed.style.transform = 'translateY(0)';
        } else {
            appointmentFixed.style.opacity = '0';
            appointmentFixed.style.transform = 'translateY(20px)';
        }
    });
